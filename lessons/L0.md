...
language. I had a brief overview in school, but never really *knew* how programming languages worked. My first attempts
...
Now, there are some great, I mean **great** tutorials out there, on how to write a language from scratch. But it's not for everyone, 
...
*Note:* You'll need the Visual Studio Extension workload installed to build the syntax project.
